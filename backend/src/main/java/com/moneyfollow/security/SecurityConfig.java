...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .cors(cors -> {}) // ⚙️ Active CORS via le bean corsFilter ci-dessous
    ...
    // 🔐 Configuration du Provider : utilise ton UserDetailsService + BCrypt
    @Bean
    ...
    // 🌍 Configuration CORS pour permettre Angular (http://localhost:4200)
    @Bean
